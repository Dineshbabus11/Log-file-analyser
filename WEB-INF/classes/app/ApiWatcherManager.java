...
public class ApiWatcherManager {
    ...
    public static synchronized void startTracking(String apiUrl, String apiKey, String indexName) {
        if (!watchers.containsKey(apiUrl)) {
            Future<?> f = executor.submit(new ApiWatcher(apiUrl, apiKey, indexName));
