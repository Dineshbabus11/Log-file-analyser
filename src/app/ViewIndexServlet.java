...
public class ViewIndexServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        List<String> globalKeys = getGlobalKeysFromMapping(client, indexName);
    ...
    private List<String> getGlobalKeysFromMapping(RestHighLevelClient client, String indexName) throws IOException {
        GetMappingsRequest getMappingsRequest = new GetMappingsRequest().indices(indexName);
        GetMappingsResponse getMappingResponse = client.indices().getMapping(getMappingsRequest, RequestOptions.DEFAULT);

        Map<String, Object> mappingSource = getMappingResponse.mappings().get(indexName).getSourceAsMap();

        Object propertiesObj = mappingSource.get("properties");
